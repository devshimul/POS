  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="products">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{ route('product.stock')}}">Products Stock </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="customers">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('customer.add')}}">Add Customer</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('customer.view')}}">View All Customer</a></li>
        </ul>
      </div>
    </li>
    ...
    <!-- <li class="nav-item">
      ...
      <div class="collapse" id="reports">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="#">Purchase Report </a></li>
          <li class="nav-item"> <a class="nav-link" href="#">Sale Report</a></li>
        </ul>
      </div>
    </li> -->
