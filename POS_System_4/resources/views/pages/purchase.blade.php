                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width="40%" colspan="4">Product</th>
                            <th>Unit</th>
                            <th>Quantity</th>
                            <th>Purchase Rate</th>
                    ...
                    <tbody id="tablebody" class="text-center">
                        <tr id="afteritemrow" class="pdrow">
                            ...
                            <td rowspan="6" colspan="5">
                                ...
                                <textarea class="form-control w-100" name="note" placeholder="Type here...." cols="30" rows="15"></textarea>
